...
#define SNARE_FILE "wave-files/100058__menegass__gui-drum-snare-hard.wav"
...
// bool isOne() { return beatNum == ONE; }

// bool isTwo() { return beatNum == TWO; }

// bool isThree() { return beatNum == THREE; }

// bool isFour() { return beatNum == FOUR; }
...
int main(void)
{
	...
	Audio_readWaveFileIntoMemory(HIHAT_FILE, &hihat);
	...
	while(1) {
		...
		// Audio_playFile(handle, &snareFile);
		beatMaker_incBeat();
		time_sleepForMs(480);
	}
